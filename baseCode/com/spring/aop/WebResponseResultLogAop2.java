...
public class WebResponseResultLogAop2 implements MethodInterceptor {
	public static final Logger logger = LoggerFactory.getLogger(WebResponseResultLogAop2.class);
